...
We always provide security updates for the [latest release](https://github.com/minio/radio/releases/latest).
Whenever there is a security update you just need to upgrade to the latest version.

## Reporting a Vulnerability

All security bugs in [minio/radio](https://github,com/minio/radio) (or other minio/* repositories)
