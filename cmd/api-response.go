...
func generateListBucketsResponse(buckets []BucketInfo) ListBucketsResponse {
	...
	owner.ID = globalRadioDefaultOwnerID
...
func generateListPartsResponse(partsInfo ListPartsInfo, encodingType string) ListPartsResponse {
	...
	listPartsResponse.StorageClass = globalRadioDefaultStorageClass
	listPartsResponse.Initiator.ID = globalRadioDefaultOwnerID
	listPartsResponse.Owner.ID = globalRadioDefaultOwnerID
...
func writeCustomErrorResponseXML(ctx context.Context, w http.ResponseWriter, err APIError, errBody string, reqURL *url.URL) {
	switch err.Code {
	case "SlowDown", "XMinioServerNotInitialized", "XMinioReadQuorum", "XMinioWriteQuorum":
		// Set retry-after header to indicate user-agents to retry request after 120secs.
		// https://developer.mozilla.org/en-US/docs/Web/HTTP/Headers/Retry-After
